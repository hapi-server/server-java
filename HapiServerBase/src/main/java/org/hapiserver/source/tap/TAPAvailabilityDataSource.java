 ...
 * @author jbf
 */
public class TAPAvailabilityDataSource extends AbstractHapiRecordSource {
...
"}";
    ...
    /**
     * creates a TapAvailabilitySource.  Note info is ignored but may be used in the future.
     * @param tapServerURL
     * @param idavail
     * @param info 
     */
    public TAPAvailabilityDataSource( String tapServerURL, String idavail, JSONObject info ) {
        int i= idavail.indexOf("/");
     ...
     * @throws IOException 
     */
    public static Iterator<HapiRecord> getDataForTesting( String idavail, String start, String stop ) throws IOException {
    ...
    public static void main( String[] args ) throws IOException {
        ...
        switch (args.length) {
            ...
            case 1:
                ...
                break;
            case 3:
                Iterator<HapiRecord> iter = TAPAvailabilityDataSource.getDataForTesting( args[0], args[1], args[2] );
                if ( iter.hasNext() ) {
